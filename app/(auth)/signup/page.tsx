...
export default function SignUpForm() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage(
          data.message || "Registration successful! Attempting to log you in..."
        );
    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] md:min-h-[calc(100vh-8rem)] bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 p-4 sm:p-6 lg:p-8">
      <div className="relative bg-white dark:bg-gray-800 p-6 sm:p-8 lg:p-10 rounded-xl shadow-2xl w-full max-w-md border border-gray-100 dark:border-gray-700 transform hover:scale-[1.01] transition-transform duration-300 ease-in-out">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-8 text-center max-w-md mx-auto">
          Sign up to access your personalized dashboard and manage your
          portfolio.
        </p>
              ...
              {showPassword ? (
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M3.988 5.842A10.022 10.022 0 0 0 3 12c0 2.972 1.153 5.748 3.053 7.74H7.94a10.022 10.022 0 0 0 7.94-7.74H15c-.244-.244-.5-.487-.756-.725A8.995 8.995 0 0 0 12 6.5C10.7 6.5 9.475 6.744 8.35 7.218"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M12 21c-.244-.244-.5-.487-.756-.725A8.995 8.995 0 0 1 12 17.5c1.3 0 2.525.244 3.65.718l1.414 1.414A10.022 10.022 0 0 0 21 12c0-2.972-1.153-5.748-3.053-7.74L19.06 4"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M16.892 16.892a1.5 1.5 0 1 0 2.122 2.121 1.5 1.5 0 0 0-2.121-2.122Z"
                  />
                </svg>
              ) : (
                // Eye icon (show)
