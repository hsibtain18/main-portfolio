...
// import { Menu, X, Sun, Moon } from "lucide-react"; // Removed Download as we're using custom SVG
...
//   // New link for resume download, marked as a button
//   { label: "Resume", href: "/Syed_Hassan_Sibtain_Resume.pdf", isButton: true, download: true },
// ];
...
//           {navLinks.map((link) => (
//             link.isButton ? (
//               // Render as a sleek, minimal button for resume download
//               <a
//                 key={link.label}
//                 href={link.href}
...
//               >
//                 {/* Custom SVG Download Icon - sleek and minimal */}
//                 <svg
...
//             {navLinks.map((link) => (
//               link.isButton ? (
//                 // Render as a sleek, minimal button for resume download in mobile
//                 <a
//                   key={link.label}
//                   href={link.href}
...
//                              hover:bg-blue-600 hover:text-white transition-colors duration-300
//                              dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-400 dark:hover:text-gray-900
//                              text-sm font-medium shadow-sm hover:shadow-md w-fit" // w-fit to prevent full width
//                   aria-label={link.label}
//                 >
...
//                 </a>
//               ) : (
//                 // Render as a regular link in mobile
//                 <Link
//                   key={link.href}
//                   href={link.href}
